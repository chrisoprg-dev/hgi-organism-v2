...
function getInterface() {
  ...
  d += "function opc(o){var pi=o.opi_score||0,pc=pi>=80?'oh':pi>=65?'om2':'olw',dd=o.due_date?new Date(o.due_date).toLocaleDateString('en-US',{month:'short',day:'numeric'}):'';return '<div class=\"oc\" onclick=\"selO('+JSON.stringify(o.id)+')\">'+'<div class=\"ot\">'+( o.title||'')+'</div>'+'<div class=\"om\"><span class=\"ob '+pc+'\">OPI '+pi+'</span><span class=\"sbdg\">'+( o.stage||'identified')+'</span>'+(dd?'<span class=\"db\">Due '+dd+'</span>':'')+'</div></div>';}";
